...
if(isset($_POST['submit']))
{
    ...
    $sql="update `customers` set  username='$username',password='$password',first_name='$first_name',last_name ='$last_name',address='$address',city='$city',zip='$zip',DriverL='$DriverL',SSN='$SSN'
